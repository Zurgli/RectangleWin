...
public sealed class AppLogic
{
    ...
    private ExecuteOptions? _options;
    ...
    public void Start()
    {
        ...
        {
            if (!Enum.TryParse<WindowAction>(binding.Action, ignoreCase: true, out var action))
                continue;
    ...
    private void OnHotkeyPressed(int id)
    {
        ...
        _dispatcher.TryEnqueue(() =>
        {
            ...
            _windowManager?.Execute(action, options: _options);
        });
    }
}
